...
import { selectIsAccountSettingsModalVisible, selectIsHelpModalVisible, selectIsLicenceModalVisible, toggleAccountSettingsModalVisible, toggleHelpModalVisible, toggleLicenceModalVisible } from '../../../../slices/modalSlices'
  ...
  return (
          ...
          <View style={styles.header}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Text style={styles.headerName}>Lisanslar</Text>
            </View>
          </View>
        </View>
               </SafeAreaView>
